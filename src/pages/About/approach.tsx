  ...
  const approachSteps = [
    {
      ...
      description:
        'We begin by listening intently to your needs and desires. Our team possesses a unique "onsite creativity gift" that often allows us to visualize your space\'s transformation during our first meeting.',
      image: "/icons/about/bulb.png",
      isReversed: false,
    },
    {
      ...
      image: "/icons/about/creative.svg",
      isReversed: true,
    },
    {
      title: "TRANSPARENT PLANNING",
      description:
        "Within 10 working days, we provide comprehensive quotations covering every aspect of your project, from furniture pieces to civil works.",
      image: "/icons/about/planning.svg",
      isReversed: false,
    },
    {
      title: "MATERIAL SELECTION",
      description:
        "We arrange personal consultations to explore fabric options, wood finishes, metal treatments, and color palettes, ensuring every element aligns with your vision.",
      image: "/icons/about/select.png",
      isReversed: true,
    },
    {
      title: "FORMAL AGREEMENT ",
      description:
        "Our projects are backed by professionally drafted contracts, reviewed and sealed by our reputable law firm, protecting your interests throughout our partnership.",
      image: "/icons/about/agreement.svg",
      isReversed: false,
    },
    {
      ...
      description:
        "Our projects are backed by professionally drafted contracts, reviewed and sealed by our reputable law firm, protecting your interests throughout our partnership",
      image: "/icons/about/sourcing.png",
      isReversed: true,
    },
  ];
    ...
    <div className="bg-[#FDFCF6] border-b pt-[40px] pb-[20px] px-[16px] lg:px-[100px] lg:pt-[0px] lg:pb-[60px] mb-[40px] lg:mb-[0px]">
      ...
      <div className="flex flex-col lg:gap-0 relative">
        ...
        {approachSteps.map((step, index) => (
          <div
            key={index}
            className={`flex flex-col lg:flex-row items-center lg:items-start lg:py-[80px] pb-[40px] relative ${
          ...
          >
            ...
            >
              <div
                className={`flex gap-6 mb-2 lg:mb-[10px] ${
                ...
                {step.bulletPoints && (
                  <ul className="list-disc font-medium mb-4 pl-5 lg:pl-[30px] space-y-[0px]">
                    {step.bulletPoints.map((point, i) => (
                      <li
                        key={i}
                        className="text-[16px] lg:text-[16px] text-[#040323] leading-[20px]"
                      >
                        {point}
                      </li>
                    ))}
            ...
            <div
              className={`lg:w-1/2 lg:h-auto flex ${
                step.isReversed
                  ? "lg:justify-end lg:pr-[48px]"
                  : "lg:justify-start lg:pl-[48px]"
              }`}
            >
              <img
                src={step.image}
                alt={step.title}
                className="h-full lg:h-auto w-full lg:w-auto object-cover"
              />
            </div>
          </div>
        ))}
